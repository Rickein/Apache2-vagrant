...
Vagrant.configure("2") do |config|
  ...
  git clone https://github.com/Rickein/introducao-html-css/tree/ac9 /var/www/introducao-html-css
  git clone https://github.com/Rickein/Apache2-vagrant/tree/ac9 /etc/apache2/sites-enable
  # git clone https://github.com/mattdesl/simple-html-index.git /var/www/simple-html-index
  rm /etc/apache2/sites-enabled/000-default.conf
  git clone https://github.com/Rickein/Apache2-vagrant/tree/ac9 /etc/apache2/sites-enabled
